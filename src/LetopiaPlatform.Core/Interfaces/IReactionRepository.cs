...
public interface IReactionRepository : IGenericRepository<Reaction>
{
    ...
    Task<IEnumerable<Reaction>> GetReactionsByTargetAsync(string targetType, Guid targetId);
    ...
    Task<int> GetReactionCountAsync(string targetType, Guid targetId, ReactionType? type = null);
    ...
    Task<Reaction?> GetUserReactionAsync(Guid userId, string targetType, Guid targetId);
}
