        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Role = table.Column<string>(type: "text", nullable: false, defaultValue: "Learner"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    topic_category = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_communities_AspNetUsers_created_by",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_communities", x => x.id);
                    table.ForeignKey(
                        name: "FK_user_communities_AspNetUsers_user_id",
                        column: x => x.user_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_user_communities_communities_community_id",
                        column: x => x.community_id,
                        principalTable: "communities",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    post_type = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "Discussion"),
            ...
            migrationBuilder.CreateIndex(
                name: "ix_communities_created_by",
                table: "communities",
                column: "created_by");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_posts_community_created",
                table: "posts",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_user_communities_user_community",
                table: "user_communities",
