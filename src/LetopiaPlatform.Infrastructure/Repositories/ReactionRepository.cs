...
public class ReactionRepository : GenericRepository<Reaction>, IReactionRepository
{
    ...
    /// <inheritdoc/>
    public async Task<IEnumerable<Reaction>> GetReactionsByTargetAsync(TargetType targetType, Guid targetId)
    {
    ...
    /// <inheritdoc/>
    public async Task<int> GetReactionCountAsync(TargetType targetType, Guid targetId, ReactionType? type = null)
    {
    ...
    /// <inheritdoc/>
    public async Task<Reaction?> GetUserReactionAsync(Guid userId, TargetType targetType, Guid targetId)
    {
        return await _context.Set<Reaction>()
