...
public class PostsController : BaseController
{
    ...
    [HttpPatch(Router.Posts.TogglePin)]
    public async Task<IActionResult> TogglePin(Guid postId)
    {
        HttpContext.AddBusinessContext("action", "toggle_pin_post");
        HttpContext.AddBusinessContext("post_id", postId.ToString());

        var userId = GetUserId();
        var result = await _postService.TogglePinAsync(postId, userId, HttpContext.RequestAborted);
    ...
    public async Task<IActionResult> DeletePost(Guid postId)
    {
        ...
        var userId = GetUserId();
        var result = await _postService.DeleteAsync(postId, userId, HttpContext.RequestAborted);
        return HandleResult(result);
    }
